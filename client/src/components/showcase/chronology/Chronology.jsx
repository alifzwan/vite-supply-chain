        ...
        <div className="flow-main-section">
            ...
            <div className="flow-content">
                <ul className="tasklist">
                    ...
                    <a href="/admin"><li>Administration: <p>NGO/GLC will change the PHASE of the product (E.g. from Poultry to Mardi)</p></li></a>
                    <a href="/mardi"><li>Mardi Verification: <p>Mardi will conduct a quality check on Poultry</p></li></a>
