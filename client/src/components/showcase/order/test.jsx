...
const Order = () => {
    ...
    const loadBlockchaindata = async () => {
        ...
        if (networkData) {
            ...
            var i;
            const itemsCount = await supplychain.methods.myItems().call();
            const item = {};
            const ItemPhase = [];
            ...
            <div className="ord-section">
                ...
                <motion.div className="input-container" variants={variants}>
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        <input type="text" name="name"  onChange={regItemName} placeholder="Name" /><br />
                    </motion.div>

                    <motion.div variants={itemVariants}>
                        <label htmlFor="categories">Categories:</label><br />
                        <input type="text" name="categories"  onChange={regItemCategories} placeholder="Categories" /><br />
                    </motion.div>

                    <motion.div variants={itemVariants}>
                        <label htmlFor="brand">Brand:</label><br />
                        <input type="text" name="brand"  onChange={regItemBrand} placeholder="Brand" /><br />
                    </motion.div>

                    <motion.div variants={itemVariants}>
                        <label htmlFor="origin">Based In:</label><br />
                        <input type="text" name="origin"  onChange={regItemOrigin} placeholder="Based In" /><br />
                    </motion.div>

                    <motion.div variants={itemVariants}>
                        <label htmlFor="description">Description</label><br />
                        <input type="text" name="description"  onChange={regItemInfo} placeholder="Description" /><br />
                    </motion.div>
