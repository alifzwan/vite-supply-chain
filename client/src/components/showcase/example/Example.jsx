...
const Example = () => {
    ...
    return (
        <div className="example-main-container">
            <div className="project-menu-bar">
                <ProjectSideBar />
            </div> 

            <div className="main-section">
                <div className="example-section-title">Product Information</div>
                <div className="example-content">
                            ...
                            <form >
                                <motion.div className="input-container" variants={itemVariants}>
                                    <motion.div variants={itemVariants}>
                                        <input type="text" placeholder="Enter Item ID" required/><br />
                                    </motion.div>

                                    <motion.div variants={itemVariants} className="example-button">
                                        <motion.button
                    ...
                    <div className="example-back-button-container">
                        <motion.div variants={itemVariants} className="example-back-button">
                            <motion.button
                                variants={itemVariants}
                                whileHover={{ scale: 1.1 }}
                                whileTap={{ scale: 0.95 }}
                                onClick={redirect_to_admin}
                            >
                                Back To Admin 
                            </motion.button>
                        </motion.div>
